! function() {
    ...
    if (window.addEventListener) {
        var r = window.StyleFix = {
            link: function(e) {
                ...
                try {
                    ...
                    "undefined" != typeof XDomainRequest && (p = new XDomainRequest, p.onerror = p.onprogress = function() {}, p.onload = n, p.open("GET", i), p.send(null))
                }
        ...
        ! function() {
            setTimeout(function() {}, 10), document.addEventListener("DOMContentLoaded", StyleFix.process, !1)
        }()
    }
}(),
    function(e) {
        ...
        if (window.StyleFix && window.getComputedStyle) {
            ...
            ! function() {
                ...
                if (n.length > 0)
                    ...
                    for (var l in n) a(StyleFix.deCamelCase(l));
                var u = {
                    uses: 0
                };
                for (var p in e) {
